...
// personalGreeting("Johnny") //This works! But for the next function to work without saying "undefined" we'll need the following, yes? 

function personalGreeting(name) {
    return "Hello, " + name + "!"
}

// console.log(personalGreeting("Johnny"))
...
let circle = {
     radius: 10,
     getArea: function() { // This is a method, because it's in an object
...
function makeOutWord(pattern, text) {
    // return pattern [0] + pattern [1] + text [2] + pattern [3]
...
// let otherText = 'ABC-DEF-GFED-AISD-WKQJEKE-DASJKDJS'
...
// if (age < 18) {
//     alert ('You are ot an adult yet')
// } else {
//     alert('You are adult')
// }

//make a game for Tuesday using prompts Solving a PROBLEM - did you do thid, yes/no, do this :)
...
//     if (machineChoice === "B") {
//         alert('You have chosen to play the betting machine')
//     } else if (machineChoice === "R") {
//         alert('You have chosen to play the roulette')
//     } else {
//         alert('You have chosen healthy lifestyle')
//     }
// }